...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, RouterOutlet, MatToolbarModule, MatSidenavModule, MatIconModule, MatListModule, MatMenuModule, MatButtonModule,SidenavComponent,ToolbarComponent],
...
export class UserLayoutComponent {
  ...
  sideBarRoutes = [
    ...
    { path: 'history', name: "History", icon: "pending_actions" },
    { path: 'report', name: "Report", icon: "assignment" },
